 ...
 * @author LENOVO
 */
public class UpdateCustomerUserServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateCustomerUserServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            Signup sign = new Signup(user_name, user_email, user_password, user_cpassword, user_mobile, user_bdate);
            
            
            SignupDao sd = new SignupDao(ConnectionProvider.getConnection());
            
            if(sd.updateCustomerUser(sign)) {
//                out.println("DONE");
...
//            out.println("<h1>Servlet UpdateCustomerUserServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
