 ...
 * @author LENOVO
 */
public class DeleteCartItemFromAdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteCartItemFromAdminServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            // fetch Data 
...
if (addCartDao.deleteCart(addCart) && sproductdao.updateQuantity(sproduct)) {
                ...
                response.sendRedirect("admin/cartDetails.jsp");
}else {
    
                out.println("<script>alert('not success');</script>");
}
            
//            out.println("<h1>Servlet DeleteCartItemFromAdminServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
