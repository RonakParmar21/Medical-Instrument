...
//                String n1 = request.getParameter("n1");
                ...
                String sql = "select * from product where  sub_cat_id='"+subid+"'";
                    ...
                    <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
                        ...
                        <div class="col hp" style="height: 380px; width: 100%; display: inline-block">
                            <div class="card h-100 shadow-sm" style="width:100%;">
                                <a href="#">
                                    <img src="assets/images/Main_Product/<%= fileName%>" class="card-img-top" alt="product.title" />
                                </a>
                                <div class="card-body">
                                    <div class="d-grid gap-2 my-4">

                                        <a href="displaySubProduct.jsp?pid=<%=  rs.getInt(1)  %>" class="btn btn-warning bold-btn"><%= rs.getString(4)%></a>
