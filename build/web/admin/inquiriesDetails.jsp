<%-- 
    Document   : inquiriesDetails
    Created on : 09-Sept-2023, 4:40:53 pm
    Author     : LENOVO
--%>
<%@page import="com.gemtrack.dao.SubProductDao" %>
<%@page import="com.gemtrack.entities.SubProduct"%>
...
//    Signup sign = new Signup();
        ...
        <!--new--> 
        <div class="container">
            <h1 style="text-align: center; margin-top: 1%;"><u>Inquiries</u></h1>
            <table style="margin-bottom: 5%; margin-top: 2%;">
                <h3><thead>
                        <tr>
                            ...
                            <th style="font-size: 20px; text-align: center;" scope="col">User Mobile</th>
                            <th style="font-size: 20px; text-align: center;" scope="col">Main Category Id</th>
                            <th style="font-size: 20px; text-align: center;" scope="col">Sub Category Id</th>
                            <th style="font-size: 20px; text-align: center;" scope="col">Product Id</th>
                            <th style="font-size: 20px; text-align: center;" scope="col">Sub Product Id</th>
                            <th style="font-size: 20px; text-align: center;" scope="col">Description</th>
                            <th style="font-size: 20px; text-align: center;" scope="col">Date</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: center;"><a href="mailto:<%=rs.getString(3)%>" class="footer-nav-link" style="margin-top: 7px;"><%= rs.getString(3) %></a></td>
                        <td style="text-align: center;"><%= rs.getString(4)%></td>
                        <td style="text-align: center;"><%= rs.getInt(5)%></td>
                        <td style="text-align: center;"><%= rs.getInt(6)%></td>
                        <td style="text-align: center;"><%= rs.getInt(7)%></td>
                        <td style="text-align: center;"><%= rs.getInt(8)%></td>
                        <td style="text-align: center;"><%= rs.getString(9)%></td>
                        <td style="text-align: center;"><%= rs.getDate("date")%></td>
                        <td>
                        <a href="mailto:<%=rs.getString(3)%>" class="btn btn-warning bold-btn" style="background-color: green; padding: 5px; cursor: pointer; width: 100%; color: white;">Answer</a>
                        </td>
<!--                        <td>
                            <a href=".DeleteSubProductServlet?id=<= rs.getInt(1)%>"><input type="submit" value="Delete" style="background-color: red; padding: 5px; cursor: pointer; width: 100%; color: white;"></a>-->
                        <!--<a href="../DeleteSubProductServlet?id=<= rs.getInt(1)%>" class="btn btn-warning bold-btn" style="background-color: red; padding: 5px; cursor: pointer; width: 100%; color: white;">Delete</a>-->
                        <!--</td>-->
