<%-- 
    Document   : mainCategoryDetails
    Created on : 26-Aug-2023, 8:27:24 pm
    Author     : LENOVO
--%>
...
//    Signup sign = new Signup();
        ...
        <!--new--> 
        <div class="container">
            <h1 style="text-align: center; margin-top: 1%;"><u>Main Category Details</u></h1>
            <table style="margin-bottom: 5%; margin-top: 2%;">
                <h3><thead>
                        <tr>
                            ...
                            <th style="font-size: 20px; text-align: center;" scope="col">Category Name</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <img src="../assets/images/Main_Categories/<%= rs.getString(3) %>" width="80" height="80"/>                        
                        </td>
                        <td style="text-align: center;"><%= rs.getString(2)%></td>
                        
                        <td>
                            <a href="updateMainCategoryDetails.jsp?mainId=<%=  rs.getString(1) %>" class="btn btn-warning bold-btn" style="background-color: green; padding: 5px; cursor: pointer; width: 100%; color: white;">Update</a>
...
<!--                        
                        < rs.getString(3)%>
                        <td><a href="updateMainCategoryDetails.jsp?nm=< rs.getString(2) %>" data-toggle="modal" ><input type="submit" value="" style="background-color: green; padding: 5px; cursor: pointer; width: 100%; color: white;">update</a></td>-->
                        <!--<td>-->
                            <!--<a href="../DeleteMainCatServlet?id=<= rs.getInt(1)%>"><input type="submit" value="Delete" style="background-color: red; padding: 5px; cursor: pointer; width: 100%; color: white;"></a>-->
                            <!--<a href=""></a>-->
                        <!--</td>-->
                    </tr>           
                </tbody>
...
//                    do {
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="updateMainCategoryDetails.jsp?nm=<  rs.getString(3) %>" class="btn btn-warning bold-btn" style="background-color: green; padding: 5px; cursor: pointer; width: 100%; color: white;">Update</a>
