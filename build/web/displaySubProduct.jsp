...
//                String n1 = request.getParameter("n1");
                ...
                String sql = "select * from sub_product where  product_id='"+product_id+"'";
                
                ResultSet rs = statement.executeQuery(sql);
//                if(!rs.next()) { %>
                        <!--<p style="width: 1340px; align-content: center; font-size: 50px; color: red; text-align: center;">No such items found</p>-->
                        <%
//                }
                while (rs.next()) {
//                if(!rs.next()) {
