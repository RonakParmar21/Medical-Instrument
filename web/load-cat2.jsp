...
//            out.println("Hello 11." + c);
            try {
                String str = "";
                String c1 = request.getParameter("cat2");
                
                //int c = Integer.parseInt(request.getParameter("cat"));
            out.println("H" + c1);
                String sql1 = "select * from sub_product where product_id = '"+c1+"'";
//                String sql = "SELECT * FROM sub_category where main_cat_name='hp'";
        ...
        %>
            ...
            <option value="<%= rs.getString("sub_product_id")%>"><%= rs.getString("model_no")%></option>
            <%
