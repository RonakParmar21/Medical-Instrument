...
//    Signup sign = new Signup();
        ...
        <!--new--> 
        <div class="container">
            <h1 style="text-align: center; margin-top: 1%;"><u>Main Product's Details</u></h1>
                        ...
                        <tr>
                            ...
                            <th style="font-size: 20px; text-align: center;" scope="col">Main Category Id</th>
                                 <th style="font-size: 20px; text-align: center;" scope="col">Sub Category Id</th>
                                      <th style="font-size: 20px; text-align: center;" scope="col">Main Product Name</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <img src="../assets/images/Main_Product/<%= rs.getString(5) %>" width="80" height="80"/>                        
                        </td>
                        ...
                        <td>
                            <a href="updateMainProductDetails.jsp?productId=<%=  rs.getInt(1) %>" class="btn btn-warning bold-btn" style="background-color: green; padding: 5px; cursor: pointer; width: 100%; color: white;">Update</a>
