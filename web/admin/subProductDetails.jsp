<%-- 
    Document   : subProductDetails
    Created on : 03-Sept-2023, 2:15:02 pm
    Author     : LENOVO
--%>
            ...
            <table style="margin-bottom: 5%; margin-top: 2%;">
                <h3><thead>
                        <tr>
                            ...
                            <th style="font-size: 20px; text-align: center;" scope="col">Model No.</th>
                                          <th style="font-size: 20px; text-align: center;" scope="col">Description</th>
                                                        <th style="font-size: 20px; text-align: center;" scope="col">Fetures</th>
                                                                      <th style="font-size: 20px; text-align: center;" scope="col">Quantity</th>
                                                                                    <th style="font-size: 20px; text-align: center;" scope="col">Price</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <img src="../assets/images/Sub_Product/<%= rs.getString(10) %>" width="80" height="80"/>                        
                        </td>
                        ...
                        <td style="text-align: center;"><%= rs.getInt(9)%></td>
                        <td>
                        <a href="updateSubProductDetails.jsp?subpId=<%=  rs.getInt(1) %>" class="btn btn-warning bold-btn" style="background-color: green; padding: 5px; cursor: pointer; width: 100%; color: white;">Update</a>
                        </td>
                        <td>
