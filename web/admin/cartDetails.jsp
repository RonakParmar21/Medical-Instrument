<%-- 
    ...
    Created on : 17-Sept-2023, 3:48:40 pm
    Author     : LENOVO
--%>
...
//    Signup sign = new Signup();
        ...
        <%    String sql = "select * from add_cart";
            ...
            <table style="margin-bottom: 5%; margin-top: 2%;">
                <h3><thead>
                        <tr>
                            ...
                            <th style="font-size: 20px; text-align: center;" scope="col">Product Name</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <form action="../DeleteCartItemFromAdminServlet" method="POST">
                    <input type="hidden" name="id" value="<%= rs.getInt(1) %>" />
                    <input type="hidden" name="p_id" value="<%= rs.getInt(3) %>" />
                    <input type="hidden" name="q" value="<%= rs.getInt(6) %>" />
                
                    <!--<td> {item.quantity * item.price} </td>-->
                    <td> 
                        <a href="DeleteCartItemServlet?id=<%= rs.getInt(1)%>">
